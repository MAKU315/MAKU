...
getwd()
setwd("C:/Users/user/Desktop/수업/텍스트마이닝")
...
for(i in 1:kn){
  ...
  # coef
  file_name=paste("C:/Users/user/Desktop/수업/텍스트마이닝/coef.csv", sep="")
  write.table(coef,file=file_name)
  
  
  file_name=paste("C:/Users/user/Desktop/수업/텍스트마이닝/Location.csv", sep="")
  Location<-tr_com$Location[(LSI.hr.Clusters==i)]
  write.table(Location,file=file_name)
  
  
  file_name=paste("C:/Users/user/Desktop/수업/텍스트마이닝/Cat.csv", sep="")
...
for(i in 6:20)
{
  ...
  file_name=paste("C:/Users/user/Desktop/텍스트마이닝/cluster",i,".csv",sep="")
